...
::: {.callout-exercise id=ex-linear-regression}
### Linear regression
...
::: {.callout-exercise id=ex-diet-regression-by-hand}
...
: Some descriptive numbers computed on the data. {#tbl-diet-descriptors-regression .table-sm}
...
::: {.callout-exercise id=ex-diet-regression-and-pca}
...
::: {.callout-exercise id=ex-standard-addition}
### Standard addition
...
: Standard addition vs signal for a calibration set. {#tbl-standard-addition .table-sm}
...
::: {.callout-exercise id=ex-standard-curve-by-hand}
...
: Measured absorbance of standard solutions .{tbl-standard-curve .table-sm}
...
::: {.callout-task}
3. Three new milk samples with unknown concentration of Ca$^{2+}$ were measured with atom absorption spectroscopy. Use the standard curve to quantify the concentrations of Ca$^{2+}$ in the new samples. The absorbance values for the three new samples are found in @tbl-unkown-concentration.
:::
...
: Absorbances for samples with unknown Ca$^{2+}$ concentration. {#tbl-unknown-concentration .table-sm}
...
::: {.callout-exercise id=ex-standard-curve-phenols}
...
: Concentrations and absorbances of standard solutions. {#tbl-phenol-standards .table-sm}
...
: Spice extracts and their absorbances. {#tbl-spice-extracts .table-sm}
